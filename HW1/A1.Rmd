...
your working directory (under the Session's menu in Rstudio) appropriately. (And yes, this really is as easy
...
kicker <- read.csv("F:/unr/FieldGoals2003to2006.csv",header=T) 
